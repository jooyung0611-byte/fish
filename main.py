...
# -----------------------------------------------------------------------------
st.set_page_config(page_title="판타지 낚시 게임 v3.0 (통합판)", page_icon="🎣", layout="wide")
...
# 5. UI 화면 구성
# -----------------------------------------------------------------------------
st.title("🎣 판타지 낚시 게임 v3.0 (최종 통합판)")
...
# 메인 탭
tab1, tab2, tab3, tab4, tab5 = st.tabs(["🌊 낚시터 (수동/자동)", "🎣 낚시대 상점", "🎒 가방 & 판매", "🛒 미끼 상점", "📖 물고기 도감"])
